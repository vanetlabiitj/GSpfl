...
class FlowerNumPyClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        file_path_control = os.path.join("../baselines/store_weights", f"server_control.pkl")
        file_path_local_control = os.path.join("../baselines/store_weights", f"cid-{self.cid}-local-c-x.pkl")
        ...
        file_path = os.path.join("../baselines/store_weights", f"cid-{self.cid}-local-c-x.pkl")
        with open(file_path, "wb") as f:
            pickle.dump(local_parm_star, f)

        file_path = os.path.join("../baselines/store_weights", f"cid-{self.cid}-local-c.pkl")
        with open(file_path, "wb") as f:
...
class FedCrime(fl.server.strategy.Strategy):
    ...
    def initialize_parameters(
        ...
        #save weights
        # file_path = os.path.join("../baselines/store_weights", f"server_weights.pkl")
        # with open(file_path, "wb") as f:
    ...
    def aggregate_fit(
        ...
        control_locals = []
        for cid in range(10):
            file_path_local_control = os.path.join("../baselines/store_weights", f"cid-{cid}-local-c.pkl")
            with open(file_path_local_control, "rb") as f:
        ...
        file_path_read_control = os.path.join("../baselines/store_weights", f"server_control.pkl")
        if server_round == 1:
        ...
        file_path_store_control = os.path.join("../baselines/store_weights", f"server_control.pkl")
        ...
        # for items in global_weights:
        #     print("i am layer shape",items.shape)
        #     print(items)
