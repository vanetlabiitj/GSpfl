...
def train(net, trainloader, learning_rate, epochs: int, proximal_mu):
...
class FlowerNumPyClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        train_loss, train_micro, train_macro = train(self.net, self.trainloader, learning_r, epochs=5, proximal_mu=1.0)
...
class FedCrime(fl.server.strategy.Strategy):
    ...
    def aggregate_fit(
        ...
        #ndarrays_to_parameters(aggregate_bulyan(weights_results, num_malicious_clients, aggregate_krum, to_keep=0))
